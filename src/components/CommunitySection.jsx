...
import allactivities from "../assets/allactivities.png";
  ...
  return (
    <>
      <div className="allactivities">
        <Link to="/donation">
          <img src={allactivities} alt={allactivities}></img>
        </Link>
      </div>
                  ...
                  <figure class="max-w-screen-md mx-auto">
                    ...
                    <blockquote>
                      <p class="text-2xl font-medium text-gray-900 ">
                        "Wow, I'm incredibly impressed with the work of WeCare.
                        Their dedication to helping those in need is truly
                        inspiring. Thanks to their platform, I was able to
                        donate surplus food and utilities with ease, knowing
                        that it would directly benefit someone who needs it
                        most."
                      </p>
                    </blockquote>
